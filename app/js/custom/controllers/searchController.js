...
var searchApi = "https://upzone.search.windows.net/indexes/trails/docs?api-version=2015-02-28&search=San&$orderby=name desc";

var searchController = angular.module("searchController",["httpService"]);

loginController.controller("searchfromController",["$scope","doGetRequest","$rootScope",function($scope,doGetRequest,$rootScope){
									 $scope.searchBody={
										 client:"",
										 property:"",
										 city:""
									 ...
									 $scope.beginSearch=function(path,animation){
